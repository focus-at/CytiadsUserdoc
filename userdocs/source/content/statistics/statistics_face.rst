...
Все отчеты **Статистики**, кроме тех, что в реальном времени, можно просматривать, настроив один раз **Глобальные условия**: **Календарь** и **Глобальный фильтр**. То есть настроив их (можно добавить новые условия фильтра или наоборот), вам не придется каждый раз настраивать их для следующего отчета – вы перейдете на страницу с новой статистикой, а **Глобальные условия** сохранятся.
