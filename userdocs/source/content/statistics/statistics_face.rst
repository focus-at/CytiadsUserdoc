...
**Глабольный фильтр** задается в поле guilabel: `Условия глобадьного фильтра`, над **Календарем**. Все условия, которые вы примените в **Глобальном фильтре**, будут распространятся на все отчеты **Статистики**. Ровно до тех пока вы лично не измените этот фильтр или не выключите его (кликните **Глобальный фильтр** / кнопка **Сбросить**).
...
1.	Кликните на значок **Глобального фильтра** (поле guilabel: `Условия глобадьного фильтра`) в разделе **Статистика**.
...
Наверняка у вас есть особенно любимые комбинации **Глобальных условий**, которые вы используете по многу раз. Например, вы часто анализируете траффик за прошедшую неделю по России. Чтобы вам дважды не настраивать **Календарь** и **Глобальный фильтр**, мы добавили возможность сохранения ваших любимых фильтров. 
