...
.. seealso::
       Предыдущий раздел - что такое офферы. 
       
       Перейти в раздел - http://cityads.com/webmaster/offers/web/
...
Если статус вебмастера позволяет работать с оффером, то, после клика на **Подключить оффер**, всплывет окно, в котором можно получить ссылки, или баннеры, или выгрузки по офферу (что это такое - в разделе **Инструменты**). В этом же окне можно настроить субаккаунт или целевую ссылку.
