...
.. seealso:: На самом деле, *подключать* оффер не нужно. Если ваш :ref:`аккаунт позволяет<account-status-label>` работать с оффером, то вы просто берете ссылку из оффера и публикуете ее у себя.
